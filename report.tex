...
\subsection{General Solution}
	...
	The center of the \ac{ide} is composed by an editing environment, where source code is edited, and a result visualizer, where results of running a program are visualized in 3D.
	...
	The editing environment and the result visualizer together with program persistence and result exportation can be visualized in Figure \ref{fig:gen:sol}.
...
\section{Schedule}
	...
	The editing environment and the result visualizer are the components where must implementation work is since they are the central part of the architecture.
