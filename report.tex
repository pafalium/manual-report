...
\subsection{IDE for GD}
	...
	It is also helpful to look at other \ac{ide}s that focus on concerns of people from yet other areas that still share a lack of knowledge of software development.
