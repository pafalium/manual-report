...
\section{Introduction (2/3pgs)}
	...
	Attending courses, reading books, using a programming environment are ways that help understanding those concepts.
	...
	As with other programming approaches, there are several environments that make it easier to program for Generative Design. 
	...
	%cloud-storage, new market, bigger market, unified distribution, multiple integrated platforms (pcs, tablets, mobile phones), almost standard wide-spread user-interface platform (html-css-javascript)
	More and more effort is being made to move applications to the cloud. 
	As the number of people with access to the internet is rising so is the opportunity to explore new possibilities of using it. 
	A benefit of being in the cloud is the higher number of computers that will have access to the application. 
	...
	%Remove.
	Online CAD applications are starting to appear. 
	Applications like Clara.io, GooCreate and OpenJSCAD are some examples.
	Each follow a different approach to modeling.
	Clara.io focuses on creating 3d modeling and is primarily a direct manipulation environment.
	GooCreate focuses on creating games. 
	It also follows a direct manipulation approach but it doesn't focus on 3d modeling.
	OpenJSCAD focuses on 3d modeling using programming.
	It can run programs written using its programming language and can show their results in 3d.
	...
	While there are some applications where Generative Design can be applied there is still room for improving its support.
