...
\subsection{DesignScript\cite{aish2012designscript}}
	...
	DesignScript is used in several environments. These include a textual editor in Autodesk AutoCAD, a dedicated graph editor called DesignScript Studio and later Dynamo. Both DesignScript Studio and Dynamo use graph based program editing.
