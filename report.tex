...
Making programming easy for everyone has been an active area of research for many years. Some examples of systems made with the purpose of introducing people to programming -- the pedagogic way -- were Logo\cite{papert1999logo} and Smalltalk\cite{goldberg1983smalltalk}. Their authors are great defenders of the notion that learning how to solve/understand problems with a computer is a greater way of learning than the traditional soak-it-all-up way -- an example of that is the Dynabook\cite{Kay:2011:PCC:800193.1971922} a handheld computer prototype where programming was a first-class citizen.
