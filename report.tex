...
\section{Evaluation (1/2pgs)}
	...
	With the results of these benchmarks we can compare how does the system stand among the other in terms of running programs.
	...
	\subsubsection{Generative Design capability}
	The variety of results that can be made using the system are also important for its evaluation.
...
\section{Conclusions}
	...
	We added that such an \ac{ide} is needed because regular \ac{ide}s for software development don't fit the needs of architects and also that it needs to be in the web to allow them to have more freedom from location or machine.
	
	We used Impromptu, IPython, Processing, DesignScript and Rosetta as examples of \ac{ide}s that acknowledge this need and pointed them as guides for what or \ac{ide} should be.
