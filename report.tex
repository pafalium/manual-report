...
\subsection{General Architecture of the Solution}
	...
	The architecture of the editing environment and the visualizer together with program persistence and result exportation can be visualized in Figure \ref{fig:gen:sol}.
